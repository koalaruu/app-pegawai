...
<body>
    ...
    <form action="{{ route('employees.store') }}" method="POST">
        ...
        <table>
            ...
            <tr>
                <td><label for="nomor_telepon">Nomor Tele-pon:</label></td>
                <td><input type="text" id="nomor_telepon" name="nomor_telepon"></td>
            </tr>
            <tr>
                <td><label for="tanggal_lahir">Tanggal La-hir:</label></td>
            ...
            <tr>
                <td><label for="tanggal_masuk">Tanggal Ma-suk:</label></td>
            ...
            <tr>
                ...
                <td>
                    <select id="status" name="status">
                        ...
                        <option val-ue="nonaktif">Nonaktif</option>
                    </select>
                </td>
            </tr>
            <tr>
